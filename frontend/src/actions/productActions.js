...
import { PRODUCT_LIST_REQUEST, PRODUCT_LIST_SUCCESS, PRODUCT_LIST_FAIL, 
    ...
    PRODUCT_REVIEW_SAVE_SUCCESS, PRODUCT_REVIEW_SAVE_FAIL, PRODUCT_REVIEW_SAVE_REQUEST 
...
const listProducts = (category = '', searchKeyword = '', sortOrder = '') => async (dispatch) => {
    try {
        ...
        console.log(`data after request with category(${category}) and sortOrder(${sortOrder}) is: `,data)
