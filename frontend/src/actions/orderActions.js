...
import {
    ...
    ORDER_SHIPPING_REQUEST, ORDER_SHIPPING_SUCCESS, ORDER_SHIPPING_FAIL
...
const finishOrder = (order) => async (dispatch, getState) => {
    try {
        dispatch({ type: ORDER_SHIPPING_REQUEST, payload: order });
        const { userSignin: { userInfo } } = getState();
